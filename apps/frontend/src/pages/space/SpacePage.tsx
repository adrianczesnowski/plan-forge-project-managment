...
import { SpaceSettingsDialog } from '@/features/settings/ui/SpaceSettingsDialog';
import { HiddenProjectsSection } from '@/features/visibility/ui/HiddenProjectsSection';
      ...
      {allProjects.length > 0 ? (
        <>
          {visibleProjects.length > 0 ? (
            ...
            <p className="mt-10 text-center text-[13px] text-faint">{t('allHidden')}</p>
          )}
